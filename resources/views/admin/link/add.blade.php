...
@section('content')
    <marquee><h2><font color='blue'>友链 添加</font></h2></marquee>
    <form class="layui-form layui-form-pane" action="{{ url("/admin/cate_add") }}" method="post" style="margin: 50px ;" id="form" enctype="multipart/form-data">
        ...
        <div class="layui-form-item" style="padding-left:400px">
            ...
            <div class="layui-input-inline">
                <input type="text" name="fname" required  lay-verify="required" placeholder="请输入友链名" autocomplete="off" class="layui-input">@php echo $errors->first('brand_name')@endphp
            </div>
        </div>
        ...
        <div class="layui-form-item" style="padding-left:400px">
            ...
            <div class="layui-input-inline">
                <input type="text" name="furl" required  lay-verify="required" placeholder="请输入友链url" autocomplete="off" class="layui-input">@php echo $errors->first('brand_name')@endphp
            </div>
        </div>
            ...
            $("input[name='btn']").click(function(){
                ...
                $.ajax({
                    ...
                    success:function(res){
                        if (res == 1) {
                            alert("成功");
                            location.href="/admin/link_index";
                        }else{
                            alert("失败");
                        }
                    }
