...
@section('content')
    <marquee><h2><font color='blue'>轮播图 添加</font></h2></marquee>
    <form class="layui-form layui-form-pane" action="{{ url("/admin/img_add") }}" method="post" style="margin: 50px ;" id="form" enctype="multipart/form-data">
        ...
        <div class="layui-form-item" style="padding-left:400px">
            ...
            <div class="layui-input-inline">
                <input type="text" name="img_name" required  lay-verify="required" placeholder="请输入图片名" autocomplete="off" class="layui-input">@php echo $errors->first('brand_name')@endphp
            </div>
        </div>
        ...
        <div class="layui-form-item" style="padding-left:400px">
            ...
            <div class="layui-input-inline">
                <input type="text" name="img_url" required  lay-verify="required" placeholder="请输入图片url" autocomplete="off" class="layui-input">@php echo $errors->first('brand_name')@endphp
            </div>
        </div>
        ...
        <div class="layui-form-item" style="padding-left:400px">
            ...
            <div class="layui-input-block">
                <input type="radio" name="is_sh" value="1" title="是" checked>
                <input type="radio" name="is_sh" value="0" title="否" >
            </div>
        </div>
